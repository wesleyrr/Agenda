...
import com.rocha.agenda.thread.EnviaAlunoTask;
import com.rocha.agenda.R;
import com.rocha.agenda.adapter.AlunosAdapter;
...
public class ListaAlunosActivity extends AppCompatActivity {
    ...
    public static final int COD_PERM_RECEIVE_SMS = 222;
    public static final int COD_PERM_CALL_PHONE = 123;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ActivityCompat.checkSelfPermission(this, android.Manifest.permission.RECEIVE_SMS)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(this,new String[]{android.Manifest.permission.RECEIVE_SMS}, COD_PERM_RECEIVE_SMS);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            ...
            case R.id.menu_visualizar_mapa:
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, final ContextMenu.ContextMenuInfo menuInfo) {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if(ActivityCompat.checkSelfPermission(ListaAlunosActivity.this, android.Manifest.permission.CALL_PHONE)
                    ...
                    ActivityCompat.requestPermissions(ListaAlunosActivity.this,
                            new String[]{android.Manifest.permission.CALL_PHONE}, COD_PERM_CALL_PHONE);
        ...
        MenuItem itemApagar = menu.add("Deletar");
